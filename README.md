...
The `main.ks` script creates a GUI window which allows selecting any of the programs
contained in `scripts` in flight. The window can be toggled on/off with action group 0.
Each script then customizes the window to show relevant readouts and their own settings.
